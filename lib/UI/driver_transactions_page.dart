...
class DriverTransactionsPage extends StatelessWidget{
            ...
            body: BlocListener<TransactionsBloc,TransactionState>(
              listener: (context,state){
                ...
                if(state is TransactionStateInitial){
                  ...
                  BlocProvider.of<TransactionsBloc>(context).add(TransactionGetTransactionsDriver());
                }
                    ...
                    return SafeArea(
                      child:Center(
                        child :IconButton(
                            ...
                            color: Colors.white,
                            onPressed:()=> BlocProvider.of<TransactionsBloc>(context).add(TransactionGetTransactionsDriver())
                        ),
                      ),
                    );
                  }
