...
class UserForgotPasswordInputPhone extends StatefulWidget{

  @override
  _UserForgotPasswordInputPhoneState createState() => new _UserForgotPasswordInputPhoneState();
}

class _UserForgotPasswordInputPhoneState extends State<UserForgotPasswordInputPhone>{
  ...
  //handle server call
  Future<void> confirmUserNumber() async{
    ...
    if(response.statusCode == 200){
      ...
      if(res['success'] == 1){
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
              builder: (context)=> UserForgotPasswordInputCodePage(phone: _phone.text.toString())
          ),
        );
      }else{
        print("This user number is not registered in the database.");
      }
    }else{
...
class UserForgotPasswordInputCodePage extends StatefulWidget{

  final String phone;
  UserForgotPasswordInputCodePage({this.phone});
  @override
  _UserForgotPasswordInputCodePage createState() => new _UserForgotPasswordInputCodePage();
}

class _UserForgotPasswordInputCodePage extends State<UserForgotPasswordInputCodePage>{

  final String phone;
  _UserForgotPasswordInputCodePage({this.phone});
  ...
  //TODO : handle reading message in the background for confirmation code
  ...
  Future<void> _confirmConfirmationCode() async{
    ...
    if(response.statusCode == 200){
      ...
      if(res["success"] == 1){
        ...
        Navigator.of(context).push(
            MaterialPageRoute(
                builder: (context)=> UserForgotPasswordNewPassword(phone: phone)
            )
        );
      }else{
        print(res["message"]);
...
class UserForgotPasswordNewPassword extends StatefulWidget{

  final String phone;
  UserForgotPasswordNewPassword({this.phone});
  @override
  _UserForgotPasswordNewPasswordState createState() => new _UserForgotPasswordNewPasswordState(phone: phone);
}

class _UserForgotPasswordNewPasswordState extends State<UserForgotPasswordNewPassword>{

  final String phone;
  _UserForgotPasswordNewPasswordState({this.phone});
  ...
  Future<void> _uploadNewPassword() async{
    ...
    if(response.statusCode == 200){
      ...
      if(res["success"] == 1){
        print(res["message"]);
        saveToPreferences(res['id'], res['name'], res['surname'], res['email'], res['phone']);
        return ChoosePage();
      }else{
        print(res["message"]);
      }
  ...
  void saveToPreferences(int id, String name, String surname, String email, String phone) async{
    ...
    prefs.setString('userProfileUrl', " ");
  }
}