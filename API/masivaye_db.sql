...
-- -----------------------------------------------------
-- Table `ashio820_masivaye`.`user_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ashio820_masivaye`.`user_data` (
...
-- -----------------------------------------------------
-- Table `ashio820_masivaye`.`driver_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ashio820_masivaye`.`driver_data` (
...
-- -----------------------------------------------------
-- Table `ashio820_masivaye`.`vehicle_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ashio820_masivaye`.`vehicle_data` (
...
-- -----------------------------------------------------
-- Table `ashio820_masivaye`.`driver_data_has_vehicle_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ashio820_masivaye`.`driver_data_has_vehicle_data` (
  ...
  CONSTRAINT `fk_driver_data_has_vehicle_data_driver_data`
    ...
    REFERENCES `ashio820_masivaye`.`driver_data` (`driver_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_driver_data_has_vehicle_data_vehicle_data1`
    FOREIGN KEY (`vehicle_data_vehicle_id`)
    REFERENCES `ashio820_masivaye`.`vehicle_data` (`vehicle_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ashio820_masivaye`.`on_going_requests`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ashio820_masivaye`.`on_going_requests` (
  ...
  CONSTRAINT `fk_on_going_requests_user_data1`
    ...
    REFERENCES `ashio820_masivaye`.`user_data` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ashio820_masivaye`.`confirmations_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ashio820_masivaye`.`confirmations_data` (
  `id` INT(12) NOT NULL AUTO_INCREMENT,
